...
export default class BrandListFilter extends React.Component {
    ...
    handleChange(e) {
        ...
        const errors = BrandListFilter.validate(value);
    ...
    render() {
        const { actionsEnabled, onDeleteClick, placeholder, filter } = this.props;

        const addDisabled = !actionsEnabled.includes('add');
        const changeDisabled = !actionsEnabled.includes('change');
                    ...
                    <div className="btn-group btn-group-justified">
                        <div className="btn-group">
                            <button type="button"
                                    ...
                                    onClick={this.handleClick.bind(this, 'change')}>
                                Сохранить
                            </button>
                        </div>
                        <div className="btn-group">
